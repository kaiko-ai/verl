...
class DAPORewardManager(RewardManagerBase):
    ...
    async def run_single(self, data: DataProto) -> dict:
        ...
        # Merge agent/env-produced fields (turn_scores, tool_rewards, transcripts, ...) into
        # extra_info, matching NaiveRewardManager; without this they never reach compute_score.
